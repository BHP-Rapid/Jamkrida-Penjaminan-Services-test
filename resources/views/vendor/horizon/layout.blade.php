...
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <div class="ms-auto horizon-toolbar">
                @if (session('horizon_user'))
                    <span class="horizon-user-pill" title="{{ session('horizon_user') }}">
                        {{ session('horizon_user') }}
                    </span>
                @endif

                <scheme-toggler></scheme-toggler>

                <button class="btn btn-muted" :class="{active: autoLoadsNewEntries}" v-on:click.prevent="autoLoadNewEntries" title="Auto Load New Entries">
                ...
                <form method="POST" action="{{ \App\Http\Middleware\HorizonSessionAuthMiddleware::horizonUrl('logout') }}" class="horizon-logout-form">
                    @csrf
                    <button type="submit" class="btn btn-muted horizon-logout-button" title="Logout" aria-label="Logout from Horizon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            <path fill-rule="evenodd" d="M3 4.25A2.25 2.25 0 015.25 2h5.5A2.25 2.25 0 0113 4.25v1a.75.75 0 01-1.5 0v-1a.75.75 0 00-.75-.75h-5.5a.75.75 0 00-.75.75v11.5c0 .414.336.75.75.75h5.5a.75.75 0 00.75-.75v-1a.75.75 0 011.5 0v1A2.25 2.25 0 0110.75 18h-5.5A2.25 2.25 0 013 15.75V4.25Zm10.72 4.22a.75.75 0 011.06 0l1 1a.75.75 0 010 1.06l-1 1a.75.75 0 11-1.06-1.06l.22-.22H8.75a.75.75 0 010-1.5h5.19l-.22-.22a.75.75 0 010-1.06Z" clip-rule="evenodd"/>
                        </svg>
                        <span class="horizon-logout-label">Keluar</span>
                    </button>
                </form>
            </div>
        </div>
